...
Route::get('/show_data', [FormController::class, 'showData']);
...
Route::get('/users/adults', [DataController::class, 'showAdultData'])->name('users.adults'); // для демонстрации Query Scope
Route::get('/users/{id}', [UserController::class, 'show'])->name('users.show');
Route::get('/users/{id}/edit', [UserController::class, 'edit'])->name('users.edit');
Route::put('/users/{id}', [UserController::class, 'update'])->name('users.update');
Route::delete('/users/{id}', [UserController::class, 'destroy'])->name('users.destroy');

Route::get('/users/json/{id}', [UserController::class, 'showApi']); // там тоже есть инфа из data
Route::get('/data/json/{id}', [DataController::class, 'showApi']);  // data отдельно
